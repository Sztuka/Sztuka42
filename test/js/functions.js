...
(function($) {
	...
	$(".panel-default").on("click", function() {
		...
		$(".panel-body").hide();
        $('.panel-body').closest('.panel-collapse').removeClass('in');

        $(".panel-default").removeClass("event-tlo")
        $(this).addClass("event-tlo")
        $(".panel-heading").find("a").addClass("collapsed")
        $(this).find(".panel-heading").find("a").removeClass("collapsed")
        body.closest('.panel-collapse').addClass('in')
		body.show();
	});
